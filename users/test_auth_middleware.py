# # ⚠️  DEPRECATED: This file has been moved to users/tests/test_auth_middleware.py
# # Please run tests from the tests/ directory structure:
# # 
# # To run tests: python manage.py test users
# #
# # This file is kept as a marker and can be safely deleted.

# from users.tests.test_auth_middleware import *  # Re-export for backward compatibility
#         data = {
#             'username': 'alice',
...
#         token = services.generate_activation_token(user)

#         resp = self.client.get(f'/api/auth/activate/?token={token}')
